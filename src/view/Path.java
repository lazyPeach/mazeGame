 ...
 * The images for the path cells of the maze are set.
 * There will be two images. One of the path and one of the robot. Firstly the image of the path is activated but when we move the robot
 * the image will switch and the image of the path will become the image for robot.
...
public class Path extends Entity{
	...
	/**
	 * Constructor in which the images for the path cells of the maze are loaded.
	 * The images are read from file, then they are set to labels which are added to the JPanel.
	 * First image loaded is the one of the path. This will be the implicit image of the JPanel.
	 */
    public Path() {
    	path = gp.getPath();
    	try {                
